...
btn.addEventListener('click', () => {
  ...
  if (user_input.value != '' && input) {
    ...
    result_div.innerHTML += '<a class="btn btn-outline-danger m-2" target="_blank" href=https://www.google.com/search?q="'+ input[1] +'"+site:pastebin.com+|+site:codebeautify.org+|+site:codepen.io+|+site:npm.runkit.com+|+site:libraries.co+|+site:coggle.it+|+site:papaly.com+|+site:trello.com+|+site:jsdelivr.net+|+site:codeshare.io+|+site:sharecode.io+|+site:repl.it > Code Leaks</a>';
